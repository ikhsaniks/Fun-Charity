...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header" style="background-color:#5E35B1;">
    <div class="mdl-layout__header-row">
      <!-- Title -->
      <span class="mdl-layout-title"><img src="<?php echo base_url('file/asset/img/FunCharityLogo.png') ?>" alt="" class="img-responsive" width="40px" height="40px"> Fun Charity</span>
    ...
    <!-- Container -->
        <div class="container" align="center" >
            ...
            <div class="jumbotron" style="background-color: #CFD8DC;">
                <img src="<?php echo base_url('file/asset/img/FunCharityLogo.png') ?>" alt="" class="img-responsive" width="250px" height="250px">
                  ...
                  <h4 id="changeText" style="color:#AD1457; margin-top:-5px;">Bencana Alam</h4>
                    ...
                    <p></p>
                  <p><a class="btn btn-danger btn-lg" href="#" role="button">Donasi Sekarang</a></p>
            </div>
            <div class="ruler"></div>
        </div>
        <div class="container" align="center">
      ...
      <div class="featured-block">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="block">
            <div class="thumbnail">
              <img src="<?php echo base_url('file/asset/img/img1.jpg') ?>" alt="" class="img-responsive">
              <div class="caption">
                <h1>Lorem ipsum</h1>
              ...
              <div class="caption">
                ...
                <div class="col-md" align="center">
                    <div class="col-sm-12 form-group">
                        <a class="btn btn-primary btn-lg" href="#">Lihat lebih banyak</a>
                    </div>
                </div>
          </div>
        </div>
