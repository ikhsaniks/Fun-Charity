  ...
  <main class="mdl-layout__content">
    ...
    <!-- Container -->
        <div class="container" align="center">
                    <div class="col-sm-8">
                      <h2>FUN CHARITY</h2>
                      <img src="<?php echo base_url('file/asset/img/banner1.jpg') ?>" alt="" style="width:600px; height:250px;">
                      <h4><strong>MISSI:</strong> Membantu kaum yang kurang beruntung atau yang kurang mampu</h4>      
